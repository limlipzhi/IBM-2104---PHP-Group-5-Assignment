...
<head>
    ...
    <!-- Page Title -->
    <title>College Directory Website</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <?php
		...
		?>
    <!-- SLIDER -->
    <section class="slider d-flex align-items-center" style="background:url(images/slider2.jpeg)">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    <h1>Discover great colleges in Malaysia</h1>
                                    <h5>Let's uncover the best colleges to learn, develop skills, and make friends nearest to you.</h5>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-10">
                                <form class="form-wrap mt-4" action="listingPage.php" method="post">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <input type="text" placeholder="Name of college" class="btn-group1" name="name">
                                        <select  class="btn-group2" name="state" style=color:grey;border-radius:0px;background-color:white;>
										<option selected="selected" style=color:grey value="none">State</option>
											<option style=color:grey value="kuala lumpur">Kuala Lumpur</option>
											<option style=color:grey value="kedah">Kedah</option>
											<option style=color:grey  value="johor">Johor</option>
											<option style=color:grey value="kelantan">Kelantan</option>
											<option style=color:grey value="penang">Penang</option>
											</select>
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="styled-heading">
                        <h3>Where is your dream college?</h3>
                    </div>
                </div>
            </div>
			<?php
                ...
                <div class="col-md-4">
                    <div class="find-place-img_wrap">
                        <div class="grid">
							...
							<a href="listingPage.php?state=penang">
                                <img src="images/penang.jpg" class="img-fluid" alt="img13"/>
                                <figcaption>
                                    <h5>Penang </h5>
                                   <?php echo"<p>$countPenang Listings</p>";
								   ?>
                                </figcaption>
                            </figure>
							</a>
                    ...
                    <div class="row find-img-align">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
									<a href="listingPage.php?state=kuala lumpur">
                                        <img src="images/kl.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Kuala Lumpur</h5>
                                            <?php echo"<p>$countKL Listings</p>";
											?>
                                        </figcaption>
										</a>
                                    </figure>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
									<a href="listingPage.php?state=kedah">
                                        <img src="images/kedah.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Kedah </h5>
                                            <?php echo"<p>$countKedah Listings</p>";
											?>
                                        </figcaption>
										</a>
                                    </figure>
                    ...
                    <div class="row find-img-align">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
									<a href="listingPage.php?state=johor">
                                        <img src="images/johor.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Johor </h5>
                                            <?php echo"<p>$countJohor Listings</p>";
											?>
                                        </figcaption>
										</a>
                                    </figure>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
									<a href="listingPage.php?state=kelantan">
                                        <img src="images/kelantan.jpg" class="img-fluid" alt="img13" />
                                        <figcaption>
                                            <h5>Kelantan</h5>
                                            <?php echo"<p>$countKelantan Listings</p>";
											?>
                                        </figcaption>
										</a>
                                    </figure>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="listingPage.php" class="btn btn-danger">VIEW ALL</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="main-block">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="styled-heading">
                        <h3>Browse by Courses Provided</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 category-responsive">
                    <a href="listingPage.php?course=it" class="category-wrap">
              ...
              <g>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="listingPage.php?course=science" class="category-wrap">
                        <div class="category-block">
              ...
              <g>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="listingPage.php?course=hospitality" class="category-wrap">
                        <div class="category-block">
              ...
              <g>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="listingPage.php?course=culinary arts" class="category-wrap">
                        <div class="category-block">
            ...
            <div class="row">
                <div class="col-md-3 category-responsive">
                    <a href="listingPage.php?course=business" class="category-wrap">
                        <div class="category-block">
              ...
              <path d="M42,21c-2.206,0-4,1.794-4,4c0,0.553,0.448,1,1,1s1-0.447,1-1c0-1.103,0.897-2,2-2s2,0.897,2,2c0,0.553,0.448,1,1,1   s1-0.447,1-1C46,22.794,44.206,21,42,21z" data-original="#000000" class="active-path" data-old_color="#ff3a6d" fill="#ff3a6d"/>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="listingPage.php?course=management" class="category-wrap">
                        <div class="category-block">
              ...
              <g>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="listingPage.php?course=literature" class="category-wrap">
                        <div class="category-block">
              ...
              <path d="M23.698,11.765H7.361c-1.809,0-3.28-1.472-3.28-3.28s1.472-3.28,3.28-3.28h0.239C7.936,2.249,10.413,0,13.438,0   c1.795,0,3.482,0.819,4.596,2.213c0.487-0.207,0.993-0.312,1.508-0.312c1.952,0,3.586,1.417,3.909,3.303h0.247   c1.809,0,3.28,1.472,3.28,3.28S25.507,11.765,23.698,11.765z M7.361,6.204c-1.258,0-2.28,1.022-2.28,2.28s1.022,2.28,2.28,2.28   h16.337c1.258,0,2.28-1.022,2.28-2.28s-1.022-2.28-2.28-2.28h-0.693c-0.267,0-0.485-0.208-0.499-0.475   c-0.082-1.586-1.384-2.828-2.964-2.828c-0.485,0-0.964,0.128-1.423,0.38c-0.223,0.124-0.508,0.056-0.652-0.155   C16.554,1.795,15.048,1,13.438,1c-2.646,0-4.786,2.073-4.873,4.721c-0.009,0.27-0.23,0.483-0.5,0.483H7.361z" data-original="#000000" class="active-path" data-old_color="#ff3a6d" fill="#ff3a6d"/>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="listingPage.php?course=engineering" class="category-wrap">
                        <div class="category-block">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="add-listing-wrap">
                        ...
                        <p>Put your College in front of millions and earn 3x profits from our listing</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-4">
					...
					if(isset($_SESSION["admin"])){
						echo" <button type='submit' class='btn btn-danger' onclick='openForm()'><span class='ti-plus'></span> ADD LISTING</button><br><br>";
					    echo" <button type='submit' class='btn btn-danger' onclick='openForm1()'><span class='ti-plus'></span> EDIT LISTING</button><br><br>";
						echo" <button type='submit' class='btn btn-danger' onclick='openForm2()'><span class='ti-plus'></span> DELETE LISTING</button>";
					}
					else
						echo"<p>Contact us today!</p>";
					?>
					</div>
                </div>
            </div>
	...
	<body>
	<div class="modal" id="addListing">
		
		<form action="" class="form-container" method="post" >
			<center><h4 style=color:black>Add Listing</h4></center>
			
			<label for="college_name"><b>College Name</b></label>
			<input type="text" placeholder="College Name" name="college_name" required>
			
			<label for="college_phone"><b>College Contact[H/P]</b></label>
			<input type="text" placeholder="College Contact" name="college_phone" required>
			
			<label for="college_site"><b>College Website</b></label>
			<input type="text" placeholder="College Website" name="college_site" required>
			
			<label for="college_state"><b>State</b></label>
				<select   name="college_state" required>
			...
			<label for="college_course"><b>Courses</b></label><br>
			<table>
				<tr>
				<td><input type="checkbox" name="college_course[]"value="IT">IT</td>
				<td><input type="checkbox" name="college_course[]"value="science">Science</td>
				<td><input type="checkbox" name="college_course[]"value="management">Management</td>
				</tr>
				<tr>
				<td><input type="checkbox" name="college_course[]"value="business">Business</td>
				<td><input type="checkbox" name="college_course[]"value="culinary arts">Culinary Arts</td>
				<td><input type="checkbox" name="college_course[]"value="engineering">Engineering</td>
				</tr>
				<tr>
				<td><input type="checkbox" name="college_course[]"value="philosophy">Philosophy</td>
				<td><input type="checkbox" name="college_course[]"value="hospitality">Hospitality</td>
				</tr>
				</table>
				<br>
			<label for="college_img"><b>Image URL</b></label>
			<input type="text" name="college_img" placeholder="Image URL" required>
			
			<label for="college_description"><b>College Description</b></label>
			<textarea name="college_description" placeholder="Description"></textarea>
	
			<label for="college_address"><b>College Address</b></label>
			<textarea name="college_address" placeholder="Address"></textarea><br>
			
			<label for="college_price"><b>College Average Tuition</b></label>
			<input type="number" name="college_price" min=0><br>
			
			<br><button type="submit" class="btn" name="addCollege">Add College</button>
			<button type="button" class="btn cancel" onclick="closeForm()">Close</button>
			
			</form>
		</div>
		
		<div class="modal" id="editListing">
		
		<form action="" class="form-container" method="post" >
			<center><h4 style=color:black>Edit Colleges</h4></center>
			<?php
				echo"<label for='college_id'><b>Choose college to edit</b></label>
					<select   name='college_id' required>
											<option selected='selected' >College Name</option> required";
												
													$sql="SELECT * FROM college";
													$result=mysqli_query($accounts,$sql);
													
													while($names=mysqli_fetch_assoc($result)){
														echo"<option value={$names['College_ID']}>{$names['College_name']}</option>";
												}
				...
				echo"
					<label for='college_name2'><b>College Name</b></label>
			<input type='text' placeholder='College Name' name='college_name2' required>
			
			<label for='college_phone2'><b>College Contact[H/P]</b></label>
			<input type='text' placeholder='College Contact' name='college_phone2' required>
			
			<label for='college_site2'><b>College Website</b></label>
			<input type='text' placeholder='College Website' name='college_site2' required>
			
			<label for='college_state2'><b>State</b></label>
				<select   name='college_state2' required>
										<option selected='selected' >State</option>
											<option value='kuala lumpur'>Kuala Lumpur</option>
											<option value='kedah'>Kedah</option>
											<option value='johor'>Johor</option>
			...
			<label for='college_course2'><b>Courses</b></label><br>
			<table>
				<tr>
				<td><input type='checkbox' name='college_course2[]'value='IT'>IT</td>
				<td><input type='checkbox' name='college_course2[]'value='science'>Science</td>
				<td><input type='checkbox' name='college_course2[]'value='management'>Management</td>
				</tr>
				<tr>
				<td><input type='checkbox' name='college_course2[]'value='business'>Business</td>
				<td><input type='checkbox' name='college_course2[]'value='culinary arts'>Culinary Arts</td>
				<td><input type='checkbox' name='college_course2[]'value='engineering'>Engineering</td>
				</tr>
				<tr>
				<td><input type='checkbox' name='college_course2[]'value='philosophy'>Philosophy</td>
				<td><input type='checkbox' name='college_course2[]'value='hospitality'>Hospitality</td>
				</tr>
				</table>
				<br>
			<label for='college_img2'><b>Image URL</b></label>
			<input type='text' name='college_img2' placeholder='Image URL' required>
			
			<label for='college_description2'><b>College Description</b></label>
			<textarea name='college_description2' placeholder='Description'></textarea>
	
			<label for='college_address2'><b>College Address</b></label>
			<textarea name='college_address2' placeholder='Address'></textarea><br>
			
			<label for='college_price2'><b>College Average Tuition</b></label>
			<input type='number' name='college_price2' min=0><br>
				";
				echo"<br><button type='submit' class='btn' name='editCollege1'>Edit College</button>
		...
		<?php
		if(isset($_POST['editCollege1'])){
				$college_id=$_POST["college_id"];
				$college_name1=$_POST["college_name2"];
				$college_phone1=$_POST["college_phone2"];
				$college_site1=$_POST["college_site2"];
				$college_state1=$_POST["college_state2"];
				$college_course1=array();
				$college_course1=$_POST["college_course2"];
				$course1=implode(",",$college_course1);
				$college_img1=$_POST["college_img2"];
				$college_address1=$_POST["college_address2"];
				$college_description1=$_POST["college_description2"];
				$college_price1=$_POST["college_price2"];
				$sql1="UPDATE college SET College_name=\"$college_name1\",Colleges_phone=\"$college_phone1\",College_address=\"$college_address1\"
					,College_site=\"$college_site1\",College_description=\"$college_description1\",State=\"$college_state1\"
					,Course=\"$course1\",College_img=\"$college_img1\",Avg_price=$college_price1 WHERE College_ID=$college_id";
				if(mysqli_query($accounts,$sql1))
		...
		<div class="modal" id="deleteListing">
		
		<form action="" class="form-container" method="post" >
			<center><h4 style=color:black>Delete College</h4></center>
			<?php
				echo"<label for='college_id1'><b>Choose college to delete</b></label>
					<select   name='college_id1' required>
											<option selected='selected' >College Name</option> required";
												...
												echo"</select><br><br>";
				echo"<br><button type='submit' class='btn' name='deleteCollege1'>Delete College</button>
		...
		<?php
			if(isset($_POST['deleteCollege1'])){
				$sql="DELETE FROM college WHERE College_ID=".$_POST['college_id1'];
    ...
    <script>
		...
		function openForm(){
			...
			function openForm2(){
				document.getElementById("deleteListing").style.display="block";
			}
			function closeForm2(){
				document.getElementById("deleteListing").style.display="none";
			}
    </script>
</body>
